...
//    private static final Dimension CHESSGRID_SIZE = new Dimension(1080 / 4 * 3 / 8, 1080 / 4 * 3 / 8);
    private Color[] backgroundColors = ChessboardColor.getColor(0);
    ...
    protected ChessComponent(ChessboardPoint chessboardPoint, Point location, ChessColor chessColor, ClickController clickController, int size, Chessboard chessboard) {
        ...
        this.addMouseListener(new MouseListener() {
            ...
            public void mouseEntered(MouseEvent e) {
                temp=backgroundColors;
                backgroundColors=new Color[]{backgroundColors[0].brighter(),backgroundColors[1].brighter()};
                repaint();
            }

            @Override
            public void mouseExited(MouseEvent e) {
                backgroundColors=temp;
                chessboard.repaint();
            }
        });
    }
    ...
    private Color[]temp=backgroundColors;
    ...
    protected void processMouseEvent(MouseEvent e) {
        ...
        if (e.getID() == MouseEvent.MOUSE_PRESSED) {
            System.out.printf("Click [%d,%d]\n", chessboardPoint.x(), chessboardPoint.y());
...
//        System.out.printf("repaint chess [%d,%d]\n", chessboardPoint.x(), chessboardPoint.y());
        Color squareColor = backgroundColors[(chessboardPoint.x() + chessboardPoint.y()) % 2];
